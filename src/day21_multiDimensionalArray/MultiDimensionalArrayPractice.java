...
public class MultiDimensionalArrayPractice {
    ...
    String [] group1 = {"Lucy", "Umran", "Sumeya", "Abidullah"}; // 4 names
    String [] group2 = {"Madiyar", "Khshayar", "Rayhane"};  // 3 names
    String [] group3 = {"Alena", "Evgeniye", "Shukur", "Hasan", "Bilel"};  // 5 names
