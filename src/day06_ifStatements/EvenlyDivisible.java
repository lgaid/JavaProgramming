...
public class EvenlyDivisible {
    ...
    boolean isDivisibleBy2 = number % 2 == 0;
            // if the number divides by 2 is equal to zero, then it's evenly divisible by 2

    boolean isDivisibleBy3 = number % 3 == 0;
        // if the number divides by 3 is equal to zero, then it's evenly divisible by 3

    boolean isDivisibleBy5 = number % 5 == 0;
        // if the number divides by 5 is equal to zero, then it's evenly divisible by 5

    boolean isDivisibleBy6 = number % 6 ==0;
        // if the number divides by 6 is equal to zero, then it's evenly divisible by 6
...
/*
Create a class named EvenlyDivisible, and write a program that can check if a number is
